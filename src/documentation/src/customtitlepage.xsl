...
<xsl:template match="mediaobject" mode="book.titlepage.recto.auto.mode"><xsl:apply-templates select="imageobject" mode="book.titlepage.recto.auto.mode"/>
</xsl:template>
...
<fo:block xsl:use-attribute-sets="book.titlepage.recto.style" text-align="center" font-size="14.4pt" space-before="2cm" font-family="{$title.fontset}">
<xsl:apply-templates select="." mode="book.titlepage.recto.mode"/>
</fo:block>
</xsl:template>

<xsl:template match="d:title" mode="book.titlepage.recto.auto.mode">
<fo:block xsl:use-attribute-sets="book.titlepage.recto.style" text-align="center" font-size="24.8832pt" space-before="3cm" font-weight="bold" font-family="{$title.fontset}">
...
<fo:block xsl:use-attribute-sets="book.titlepage.recto.style" font-size="17.28pt" font-weight="normal" keep-with-next.within-column="always" space-before="2in">
<xsl:apply-templates select="." mode="book.titlepage.recto.mode"/>
</fo:block>
</xsl:template>
