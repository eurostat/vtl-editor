...
export class VtlParser extends Parser {
    ...
    public static readonly ruleNames: string[] = [
        ...
        "havingClause", "parameterItem", "outputParameterType", "inputParameterType",
        "rulesetType", "scalarType", "componentType", "datasetType", "scalarSetType",
        ...
        "codeItemRelationClause", "scalarTypeConstraint", "compConstraint", "multModifier",
    ...
    private static readonly _LITERAL_NAMES: Array<string | undefined> = [
        ...
        "'pivot'", "'customPivot'", "'unpivot'", "'sub'", "'apply'", "'conditioned'",
        ...
        "'language'", undefined, undefined, undefined, undefined, undefined, undefined,
        undefined, undefined, undefined, undefined, undefined, undefined, undefined,
        undefined, undefined, undefined, undefined, "';'",
    ];
    private static readonly _SYMBOLIC_NAMES: Array<string | undefined> = [
        undefined, undefined, "LPAREN", "RPAREN", "QLPAREN", "QRPAREN", "GLPAREN",
        "GRPAREN", "EQ", "LT", "MT", "ME", "NEQ", "LE", "PLUS", "MINUS", "MUL",
        "DIV", "COMMA", "POINTER", "ASSIGN", "MEMBERSHIP", "EVAL", "IF", "THEN",
        "ELSE", "USING", "WITH", "CURRENT_DATE", "ON", "DROP", "KEEP", "CALC",
        "ATTRCALC", "RENAME", "AS", "AND", "OR", "XOR", "NOT", "BETWEEN", "IN",
        "NOT_IN", "NULL_CONSTANT", "ISNULL", "EX", "UNION", "DIFF", "SYMDIFF",
        "INTERSECT", "KEYS", "INTYEAR", "INTMONTH", "INTDAY", "CHECK", "EXISTS_IN",
        ...
        "MAPS_FROM", "MAPS_TO", "MAP_TO", "MAP_FROM", "RETURNS", "PIVOT", "CUSTOMPIVOT",
        "UNPIVOT", "SUBSPACE", "APPLY", "CONDITIONED", "PERIOD_INDICATOR", "SINGLE",
        ...
        "NUMBER_CONSTANT", "BOOLEAN_CONSTANT", "STRING_CONSTANT", "IDENTIFIER",
        "MONTH", "DAY", "YEAR", "WEEK", "HOURS", "MINUTES", "SECONDS", "DATE_FORMAT",
    ...
    public exprComponent(_p?: number): ExprComponentContext {
        ...
        let _parentctx: ParserRuleContext = this._ctx;
        let _parentState: number = this.state;
        let _localctx: ExprComponentContext = new ExprComponentContext(this._ctx, _parentState);
            ...
            this.enterOuterAlt(_localctx, 1);
            {
                ...
                switch (this.interpreter.adaptivePredict(this._input, 6, this._ctx)) {
                    ...
                    case 3: {
                        ...
                        _la = this._input.LA(1);
                        if (!(((((_la - 14)) & ~0x1F) === 0 && ((1 << (_la - 14)) & ((1 << (VtlParser.PLUS - 14)) | (1 << (VtlParser.MINUS - 14)) | (1 << (VtlParser.NOT - 14)))) !== 0))) {
                            (_localctx as UnaryExprCompContext)._op = this._errHandler.recoverInline(this);
                        } else {
                            if (this._input.LA(1) === Token.EOF) {
                                this.matchedEOF = true;
                            }
                        ...
                        this.state = 294;
                        (_localctx as UnaryExprCompContext)._right = this.exprComponent(10);
                    }
                        break;
                    ...
                    case 4: {
                        ...
                        this.match(VtlParser.IF);
                        this.state = 296;
                        (_localctx as IfExprCompContext)._conditionalExpr = this.exprComponent(0);
                        this.state = 297;
                        this.match(VtlParser.THEN);
                        this.state = 298;
                        (_localctx as IfExprCompContext)._thenExpr = this.exprComponent(0);
                        this.state = 299;
                        this.match(VtlParser.ELSE);
                        this.state = 300;
                        (_localctx as IfExprCompContext)._elseExpr = this.exprComponent(3);
                    }
                        break;
                        ...
                        _prevctx = _localctx;
                        {
                            ...
                            switch (this.interpreter.adaptivePredict(this._input, 8, this._ctx)) {
                                case 1: {
                                    ...
                                    this.pushNewRecursionContext(_localctx, _startState, VtlParser.RULE_exprComponent);
                                    this.state = 306;
                                    if (!(this.precpred(this._ctx, 9))) {
                                        throw new FailedPredicateException(this, "this.precpred(this._ctx, 9)");
                                    }
                                    this.state = 307;
                                    (_localctx as ArithmeticExprCompContext)._op = this._input.LT(1);
                                    _la = this._input.LA(1);
                                    if (!(_la === VtlParser.MUL || _la === VtlParser.DIV)) {
                                        (_localctx as ArithmeticExprCompContext)._op = this._errHandler.recoverInline(this);
                                    } else {
                                        if (this._input.LA(1) === Token.EOF) {
                                            this.matchedEOF = true;
                                        }
                                    ...
                                    this.state = 308;
                                    (_localctx as ArithmeticExprCompContext)._right = this.exprComponent(10);
                                }
                                    break;
                                ...
                                case 2: {
                                    ...
                                    this.state = 310;
                                    (_localctx as ArithmeticExprOrConcatCompContext)._op = this._input.LT(1);
                                    _la = this._input.LA(1);
                                    if (!(_la === VtlParser.PLUS || _la === VtlParser.MINUS || _la === VtlParser.CONCAT)) {
                                        (_localctx as ArithmeticExprOrConcatCompContext)._op = this._errHandler.recoverInline(this);
                                    } else {
                                        if (this._input.LA(1) === Token.EOF) {
                                            this.matchedEOF = true;
                                        }
                                    ...
                                    this.state = 311;
                                    (_localctx as ArithmeticExprOrConcatCompContext)._right = this.exprComponent(9);
                                }
                                    break;
                                ...
                                case 3: {
                                    ...
                                    this.state = 314;
                                    (_localctx as ComparisonExprCompContext)._right = this.exprComponent(8);
                                }
                                    break;
                                ...
                                case 4: {
                                    ...
                                    this.state = 317;
                                    (_localctx as BooleanExprCompContext)._op = this.match(VtlParser.AND);
                                    this.state = 318;
                                    (_localctx as BooleanExprCompContext)._right = this.exprComponent(6);
                                }
                                    break;
                                ...
                                case 5: {
                                    ...
                                    this.state = 320;
                                    (_localctx as BooleanExprCompContext)._op = this._input.LT(1);
                                    _la = this._input.LA(1);
                                    if (!(_la === VtlParser.OR || _la === VtlParser.XOR)) {
                                        (_localctx as BooleanExprCompContext)._op = this._errHandler.recoverInline(this);
                                    } else {
                                        if (this._input.LA(1) === Token.EOF) {
                                            this.matchedEOF = true;
                                        }
                                    ...
                                    this.state = 321;
                                    (_localctx as BooleanExprCompContext)._right = this.exprComponent(5);
                                }
                                    break;
                                ...
                                case 6: {
                                    ...
                                    this.state = 323;
                                    (_localctx as InNotInExprCompContext)._op = this._input.LT(1);
                                    _la = this._input.LA(1);
                                    if (!(_la === VtlParser.IN || _la === VtlParser.NOT_IN)) {
                                        (_localctx as InNotInExprCompContext)._op = this._errHandler.recoverInline(this);
                                    } else {
                                        if (this._input.LA(1) === Token.EOF) {
                                            this.matchedEOF = true;
                                        }
    ...
    public functionsComponents(): FunctionsComponentsContext {
        let _localctx: FunctionsComponentsContext = new FunctionsComponentsContext(this._ctx, this.state);
    ...
    public genericOperatorsComponent(): GenericOperatorsComponentContext {
        let _localctx: GenericOperatorsComponentContext = new GenericOperatorsComponentContext(this._ctx, this.state);
    ...
    public parameterComponent(): ParameterComponentContext {
        let _localctx: ParameterComponentContext = new ParameterComponentContext(this._ctx, this.state);
    ...
    public stringOperatorsComponent(): StringOperatorsComponentContext {
        let _localctx: StringOperatorsComponentContext = new StringOperatorsComponentContext(this._ctx, this.state);
        ...
        try {
            ...
            switch (this._input.LA(1)) {
                ...
                {
                    this.state = 645;
                    (_localctx as UnaryStringFunctionComponentContext)._op = this._input.LT(1);
                    _la = this._input.LA(1);
                    if (!(((((_la - 81)) & ~0x1F) === 0 && ((1 << (_la - 81)) & ((1 << (VtlParser.LEN - 81)) | (1 << (VtlParser.TRIM - 81)) | (1 << (VtlParser.UCASE - 81)) | (1 << (VtlParser.LCASE - 81)))) !== 0) || _la === VtlParser.LTRIM || _la === VtlParser.RTRIM)) {
                        (_localctx as UnaryStringFunctionComponentContext)._op = this._errHandler.recoverInline(this);
                    } else {
                        if (this._input.LA(1) === Token.EOF) {
                            this.matchedEOF = true;
                        }
                    ...
                    this.enterOuterAlt(_localctx, 3);
                {
                    ...
                    this.match(VtlParser.COMMA);
                    this.state = 666;
                    (_localctx as ReplaceAtomComponentContext)._param = this.exprComponent(0);
                    this.state = 669;
                    this._errHandler.sync(this);
                    _la = this._input.LA(1);
                    if (_la === VtlParser.COMMA) {
                    ...
                    this.enterOuterAlt(_localctx, 4);
                {
                    ...
                    this.match(VtlParser.COMMA);
                    this.state = 677;
                    (_localctx as InstrAtomComponentContext)._param = this.exprComponent(0);
                    this.state = 680;
                    this._errHandler.sync(this);
    ...
    public numericOperatorsComponent(): NumericOperatorsComponentContext {
        let _localctx: NumericOperatorsComponentContext = new NumericOperatorsComponentContext(this._ctx, this.state);
        ...
        try {
            ...
            switch (this._input.LA(1)) {
                    ...
                    this.enterOuterAlt(_localctx, 1);
                {
                    ...
                    _la = this._input.LA(1);
                    if (!(((((_la - 73)) & ~0x1F) === 0 && ((1 << (_la - 73)) & ((1 << (VtlParser.ABS - 73)) | (1 << (VtlParser.LN - 73)) | (1 << (VtlParser.EXP - 73)))) !== 0) || ((((_la - 123)) & ~0x1F) === 0 && ((1 << (_la - 123)) & ((1 << (VtlParser.CEIL - 123)) | (1 << (VtlParser.FLOOR - 123)) | (1 << (VtlParser.SQRT - 123)))) !== 0))) {
                        (_localctx as UnaryNumericComponentContext)._op = this._errHandler.recoverInline(this);
                    } else {
                        if (this._input.LA(1) === Token.EOF) {
                            this.matchedEOF = true;
                        }
                ...
                {
                    this.state = 718;
                    (_localctx as UnaryWithOptionalNumericComponentContext)._op = this._input.LT(1);
                    _la = this._input.LA(1);
                    if (!(_la === VtlParser.TRUNC || _la === VtlParser.ROUND)) {
                        (_localctx as UnaryWithOptionalNumericComponentContext)._op = this._errHandler.recoverInline(this);
                    } else {
                        if (this._input.LA(1) === Token.EOF) {
                            this.matchedEOF = true;
                        }
                ...
                {
                    this.state = 727;
                    (_localctx as BinaryNumericComponentContext)._op = this._input.LT(1);
                    _la = this._input.LA(1);
                    if (!(((((_la - 76)) & ~0x1F) === 0 && ((1 << (_la - 76)) & ((1 << (VtlParser.LOG - 76)) | (1 << (VtlParser.POWER - 76)) | (1 << (VtlParser.MOD - 76)))) !== 0))) {
                        (_localctx as BinaryNumericComponentContext)._op = this._errHandler.recoverInline(this);
                    } else {
                        if (this._input.LA(1) === Token.EOF) {
                            this.matchedEOF = true;
                        }
                    ...
                    this.match(VtlParser.LPAREN);
                    this.state = 729;
                    (_localctx as BinaryNumericComponentContext)._left = this.exprComponent(0);
                    this.state = 730;
                    this.match(VtlParser.COMMA);
                    this.state = 731;
                    (_localctx as BinaryNumericComponentContext)._right = this.exprComponent(0);
                    this.state = 732;
                    this.match(VtlParser.RPAREN);
                }
                    break;
    ...
    public comparisonOperatorsComponent(): ComparisonOperatorsComponentContext {
        let _localctx: ComparisonOperatorsComponentContext = new ComparisonOperatorsComponentContext(this._ctx, this.state);
        ...
        try {
            ...
            switch (this._input.LA(1)) {
                    ...
                    this.enterOuterAlt(_localctx, 1);
                {
                    ...
                    this.match(VtlParser.LPAREN);
                    this.state = 772;
                    (_localctx as BetweenAtomComponentContext)._element = this.exprComponent(0);
                    this.state = 773;
                    this.match(VtlParser.COMMA);
                    this.state = 774;
                    (_localctx as BetweenAtomComponentContext)._from_ = this.exprComponent(0);
                    this.state = 775;
                    this.match(VtlParser.COMMA);
                    this.state = 776;
                    (_localctx as BetweenAtomComponentContext)._to_ = this.exprComponent(0);
                    this.state = 777;
                    this.match(VtlParser.RPAREN);
                }
                    break;
                    ...
                    this.enterOuterAlt(_localctx, 2);
                {
                    ...
                    this.match(VtlParser.LPAREN);
                    this.state = 781;
                    (_localctx as CharsetMatchAtomComponentContext)._left = this.exprComponent(0);
                    this.state = 782;
                    this.match(VtlParser.COMMA);
                    this.state = 783;
                    (_localctx as CharsetMatchAtomComponentContext)._right = this.exprComponent(0);
                    this.state = 784;
                    this.match(VtlParser.RPAREN);
                }
                    break;
    ...
    public timeOperatorsComponent(): TimeOperatorsComponentContext {
        let _localctx: TimeOperatorsComponentContext = new TimeOperatorsComponentContext(this._ctx, this.state);
        ...
        try {
            ...
            switch (this._input.LA(1)) {
                    ...
                    this.enterOuterAlt(_localctx, 3);
                {
                    ...
                    _la = this._input.LA(1);
                    if (!(_la === VtlParser.FLOW_TO_STOCK || _la === VtlParser.STOCK_TO_FLOW)) {
                        (_localctx as FlowAtomComponentContext)._op = this._errHandler.recoverInline(this);
                    } else {
                        if (this._input.LA(1) === Token.EOF) {
                            this.matchedEOF = true;
                        }
    ...
    public conditionalOperatorsComponent(): ConditionalOperatorsComponentContext {
        let _localctx: ConditionalOperatorsComponentContext = new ConditionalOperatorsComponentContext(this._ctx, this.state);
    ...
    public aggrOperators(): AggrOperatorsContext {
        let _localctx: AggrOperatorsContext = new AggrOperatorsContext(this._ctx, this.state);
            ...
            switch (this.interpreter.adaptivePredict(this._input, 95, this._ctx)) {
                    ...
                    this.enterOuterAlt(_localctx, 1);
                {
                    ...
                    if (!(((((_la - 68)) & ~0x1F) === 0 && ((1 << (_la - 68)) & ((1 << (VtlParser.MIN - 68)) | (1 << (VtlParser.MAX - 68)) | (1 << (VtlParser.SUM - 68)) | (1 << (VtlParser.AVG - 68)) | (1 << (VtlParser.MEDIAN - 68)) | (1 << (VtlParser.COUNT - 68)))) !== 0) || ((((_la - 128)) & ~0x1F) === 0 && ((1 << (_la - 128)) & ((1 << (VtlParser.STDDEV_POP - 128)) | (1 << (VtlParser.STDDEV_SAMP - 128)) | (1 << (VtlParser.VAR_POP - 128)) | (1 << (VtlParser.VAR_SAMP - 128)))) !== 0))) {
                        (_localctx as AggrCompContext)._op = this._errHandler.recoverInline(this);
                    } else {
                        if (this._input.LA(1) === Token.EOF) {
                            this.matchedEOF = true;
                        }
    ...
    public anFunctionComponent(): AnFunctionComponentContext {
        let _localctx: AnFunctionComponentContext = new AnFunctionComponentContext(this._ctx, this.state);
        ...
        try {
            ...
            switch (this._input.LA(1)) {
                ...
                {
                    this.state = 1095;
                    (_localctx as AnSimpleFunctionComponentContext)._op = this._input.LT(1);
                    _la = this._input.LA(1);
                    if (!(((((_la - 68)) & ~0x1F) === 0 && ((1 << (_la - 68)) & ((1 << (VtlParser.MIN - 68)) | (1 << (VtlParser.MAX - 68)) | (1 << (VtlParser.SUM - 68)) | (1 << (VtlParser.AVG - 68)) | (1 << (VtlParser.MEDIAN - 68)) | (1 << (VtlParser.COUNT - 68)))) !== 0) || ((((_la - 128)) & ~0x1F) === 0 && ((1 << (_la - 128)) & ((1 << (VtlParser.STDDEV_POP - 128)) | (1 << (VtlParser.STDDEV_SAMP - 128)) | (1 << (VtlParser.VAR_POP - 128)) | (1 << (VtlParser.VAR_SAMP - 128)) | (1 << (VtlParser.FIRST_VALUE - 128)) | (1 << (VtlParser.LAST_VALUE - 128)))) !== 0))) {
                        (_localctx as AnSimpleFunctionComponentContext)._op = this._errHandler.recoverInline(this);
                    } else {
                        if (this._input.LA(1) === Token.EOF) {
                            this.matchedEOF = true;
                        }
                    ...
                    this.enterOuterAlt(_localctx, 2);
                {
                    ...
                    _la = this._input.LA(1);
                    if (!(_la === VtlParser.LAG || _la === VtlParser.LEAD)) {
                        (_localctx as LagOrLeadAnComponentContext)._op = this._errHandler.recoverInline(this);
                    } else {
                        if (this._input.LA(1) === Token.EOF) {
                            this.matchedEOF = true;
                        }
                ...
                {
                    this.state = 1132;
                    (_localctx as RankAnComponentContext)._op = this.match(VtlParser.RANK);
                    this.state = 1133;
                    this.match(VtlParser.LPAREN);
                    this.state = 1134;
                    this.match(VtlParser.OVER);
                ...
                {
                    this.state = 1144;
                    (_localctx as RatioToReportAnComponentContext)._op = this.match(VtlParser.RATIO_TO_REPORT);
                    this.state = 1145;
                    this.match(VtlParser.LPAREN);
                    this.state = 1146;
                    this.exprComponent(0);
    ...
    public optionalExprComponent(): OptionalExprComponentContext {
        let _localctx: OptionalExprComponentContext = new OptionalExprComponentContext(this._ctx, this.state);
    ...
    public sempred(_localctx: RuleContext, ruleIndex: number, predIndex: number): boolean {
        switch (ruleIndex) {
            ...
            case 3:
                return this.exprComponent_sempred(_localctx as ExprComponentContext, predIndex);
        }
        return true;
    }
    ...
    private exprComponent_sempred(_localctx: ExprComponentContext, predIndex: number): boolean {
        switch (predIndex) {
            case 8:
                return this.precpred(this._ctx, 9);
...
export class ArithmeticExprCompContext extends ExprComponentContext {
    ...
    public exprComponent(i?: number): ExprComponentContext | ExprComponentContext[] {
        if (i === undefined) {
...
export class CallComponentContext extends GenericOperatorsComponentContext {
    ...
    public parameterComponent(i?: number): ParameterComponentContext | ParameterComponentContext[] {
        if (i === undefined) {
...
export class SubstrAtomComponentContext extends StringOperatorsComponentContext {
    ...
    public optionalExprComponent(i?: number): OptionalExprComponentContext | OptionalExprComponentContext[] {
        if (i === undefined) {
